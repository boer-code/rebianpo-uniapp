...
export default defineConfig({
  ...
  safelist: ['i-carbon-code', 'i-carbon-home', 'i-carbon-user', 'i-carbon-document', 'i-carbon-chat', 'i-carbon-user-avatar', 'i-carbon-iot-platform', 'i-carbon-location', 'i-carbon-cube', 'i-carbon-chip', 'i-carbon-send'],
  rules: [
    [
      'p-safe',
      {
